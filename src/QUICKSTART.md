...
```bash
# Parse a single file
python -m llm_parser.cli parse --file data/YogeshKulkarniLinkedInProfile.pdf

# Parse multiple files in a folder
python -m llm_parser.cli parse --folder data/

# With additional options
python -m llm_parser.cli parse --file resume.pdf --verbose --no-cache

# Get help
python -m llm_parser.cli --help
```
...
3. ✅ Customize prompts in `llm_parser/config/prompts.yaml`
4. ✅ Read full documentation in `llm_parser/README.md`
5. ✅ Run tests: `pytest`

## Need Help?

- Full docs: `src/llm_parser/README.md`
